        ...
        g = {
            ru: {
                ...
                voice: {
                    ...
                    siteColorDarkBlueOnBlue:
                        "Цвет сайта тёмно-синим по голубому",
            ...
            kg: {
                text: {
                    ...
                    builtElements:
                        "Include inline elements (Videos, maps, etc.)",
                    on: "Enable",
                    off: "Disabled",
        ...
        Bvi: (function () {
            function e(t) {
                i(this, e),
                    ...
                    this._init(),
                    console.log(
                        "Bvi console: ready Button visually impaired v1.0.0"
                    );
            }
            return (
                o(e, [
                            ...
                            r(),
                                ...
                                i(t.imagesOff, function () {
                                    e._setAttrDataBviBody("images", "false"),
                                        d("images", "false"),
                                        e._speech(
                                            "".concat(e._i18n.v("imagesOFF"))
                                        ),
                                        n(t.imagesOff);
                                }),
                                i(t.imagesGrayscale, function () {
                                    e._setAttrDataBviBody(
                                        "images",
                                        "grayscale"
                                    ),
                                        d("images", "grayscale"),
                                ...
                                i(t.reset, function () {
                                    e._speech(
                                        "".concat(e._i18n.v("resetSettings"))
                                    ),
                                        v(e._config, function (t) {
                                            e._setAttrDataBviBody(
                                                t,
                                ...
                                f(t.links, function (n) {
                                    i(n, function (n) {
                                        var i =
                                            n.target.getAttribute("data-bvi");
                                        "close" === i &&
                                            (e._setAttrDataBviBody(
                                                "panelActive",
                                                "false"
                                ...
                                if (i) {
                                    t &&
                                        ...
                                        i.forEach(function (e, t) {
                                            var n =
                                                "bvi-speech-text-id-".concat(
                                                    t + 1
                                                );
                                            s(
                                                e,
                                                "div",
                                                "bvi-speech-text ".concat(n)
                                            ),
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            if ("speechSynthesis" in window && l(m("speech"))) {
                                ...
                                c.forEach(function (e) {
                                    var o = new SpeechSynthesisUtterance(
                                        e.trim()
                                    );
                                    (o.volume = 1),
                                        (o.rate = 1),
